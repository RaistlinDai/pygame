...
class Backstab(ISkill):
    ...
    def __init__(self):
        ...
        self.__image_select = pygame.image.load(Materials_Constant.rogue_backstab_select_image_filename).convert_alpha()
        self.__image_inactive = pygame.image.load(Materials_Constant.rogue_backstab_inactive_image_filename).convert_alpha()
